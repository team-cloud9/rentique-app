        ...
        try {
            ...
            if (error.code === "auth/email-already-in-use") {
                ...
                if (profile && profile.roles && profile.roles.includes('customer')) {
                    ...
                    await modalService.showAlert('Already Registered', errorMessage);
                    ...
                    if (existingPassword) {
                        try {
                            ...
                            await modalService.showAlert('Success!', 'Customer role added. Please complete your profile.');
                            
                            document.querySelector(".left").style.display = "none";
                            if (document.querySelector(".right")) document.querySelector(".right").style.display = "none";
                            userProfileModal.style.display = "flex";
                        } catch (signInError) {
                            await modalService.showAlert('Verification Failed', 'The password you entered was incorrect.');
            ...
            try {
                ...
                const profileData = {
                    ...
                    location: {
                        ...
                        geopoint: new GeoPoint(43.7001, -79.4163) 
                    },
